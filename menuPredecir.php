...
<body>
    ...
    <section class="presentacion">
        <div class="contenido">
        <div class="titulo">PREDICE TU CAMPEÓN</div>
            <div class="textoMenu">
                <label>Analiza a los corredores,</label> <br>
                <label>Analiza los circuitos y sus estrategias,</label> <br>
                <label>¡Preparate para elegir a tu campeon!</label>
            </div>
        </div>
    </section>
    ...
    <div class="imgContainer">
        ...
        <img src="imagenesMenu/imagenesMenuPredecir/predecir1ps.png" alt="">
        </div>
        <div class="video video2">
        <img src="imagenesMenu/imagenesMenuPredecir/predecir2ps.png" alt="">
        </div>
        <div class="video video3">
        <img src="imagenesMenu/imagenesMenuPredecir/predecir3ps.png" alt="">
        </div>
    </div>
