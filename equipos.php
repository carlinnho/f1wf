...
<body>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="https://drive.google.com/uc?export=view&id=1ctTpp_8Z7pj3zOt-nXfRqaZ-NXm1Sqca" alt="" class="imagen">
                </div>
    ...
    <a href="equiposHTML/Ferrari.php" class="equipo">
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="https://drive.google.com/uc?export=view&id=1WT-b1xWeETCv9mDnmgbLzbvTm_Igl-6t" alt="" class="imagen">
                </div>
                <div class="flip-card-back">
    ...
    <a href="equiposHTML/Mclaren.php" class="equipo">
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="https://drive.google.com/uc?export=view&id=1AWVraDSTgg40QzFfq_uRwPeJQkfS-nkw" alt="" class="imagen">
                </div>
                <div class="flip-card-back">
    ...
    <a href="equiposHTML/Alpine.php" class="equipo">
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="https://drive.google.com/uc?export=view&id=1_bIU_4so311BmVSm2puSewEY93Amvzak" alt="" class="imagen">
                </div>
                <div class="flip-card-back">
    ...
    <a href="equiposHTML/mercedes.php" class="equipo">
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="https://drive.google.com/uc?export=view&id=1koSo2M1Xv5UP4OHBfsPUxaZZkohCTXXq" alt="" class="imagen">
                </div>
                <div class="flip-card-back">
    ...
    <a href="equiposHTML/haas.php" class="equipo">
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="https://drive.google.com/uc?export=view&id=13fdM8V_eOygEymJQFuLe9nG999fe0Vly" alt="" class="imagen">
                </div>
                <div class="flip-card-back">
    ...
    <a href="equiposHTML/williams.php" class="equipo">
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="https://drive.google.com/uc?export=view&id=1lj1FurMhoyXWK4vbs63yORB7M1XJpLZG" alt="" class="imagen">
                </div>
                <div class="flip-card-back">
    ...
    <a href="equiposHTML/RedBull.php" class="equipo">
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="https://drive.google.com/uc?export=view&id=1E7-qHIJV8rTDLwNdtzHY0s7FWIs3NthQ" alt="" class="imagen">
                </div>
                <div class="flip-card-back">
    ...
    <a href="equiposHTML/astonmartin.php" class="equipo">
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="https://drive.google.com/uc?export=view&id=1-SijSTYw_eBuQ0AoniIpe2o6aZGqmdWN" alt="" class="imagen">
                </div>
                <div class="flip-card-back">
    ...
    <a href="equiposHTML/RB.php" class="equipo">
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front">
                    <img src="https://drive.google.com/uc?export=view&id=1tZYk08Kv_uepFpwvBKEjapGOzej5q9v9" alt="" class="imagen">
                </div>
                <div class="flip-card-back">
